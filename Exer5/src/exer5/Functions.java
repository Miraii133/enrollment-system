...
class DBPermissions {
    ...
    public void GrantStudentPermission(String studid){
        
    }
    
    public void RevokeStudentPermission(){
        
    }
    
    public void GrantTeacherPermission(){
        
    }
    
    public void RevokeTeacherPermission(){
