...
public class LoginGUIJFrame extends javax.swing.JFrame {
    ...
    private boolean isSelectedToHideDB(String dbName){
        ...
        // userId to be used by getResultSetSQL in Functions
        // since userId is required to get specific assigned subjects
        // from a teacher.
        public static String userId;
        
        // studentUserId is used for CreatePDF generatePDF() to get the
        // student id
        private int studentUserId;
    
        
    private void filterStudentUserId(String userName){

        
        // example: 1Jiyo
        // check if char 1 is already a letter or not, if not, take it as well]
    ...
    private void filterTeacherUserId(String userName){
        if(userName.charAt(0) != 't'){
            return;
        }
        
        LoginGUIJFrame.userId = userName.replaceAll("\\D+","");
    }

    
    private void getLoginInfo(){                                         
        userName = userId_textField.getText();
        filterTeacherUserId(userName);
        filterStudentUserId(userName);
        db.setUser(userName);   
